...
const HeroSection = () => {
    return (<section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center py-12 text-white">
        <div>
            <h1 className="text-2xl md:text-5xl font-extrabold leading-tight">Hi, I’m Joshua. Frontend Engineer</h1>
            ...
            <div className="flex justify-start gap-4 mt-6">
                ...
                <a
                    ...
                    className="flex items-center text-[10px] md:text-[16px] gap-2 px-5 py-3 bg-gray-800 text-white rounded-lg shadow-md hover:bg-gray-900 transition duration-300"
                >
                    <FileText size={18} />
                    Preview CV
                </a>
                ...
                <a
                    ...
                    className="flex items-center text-[10px] md:text-[16px] gap-2 px-5 py-3 bg-blue-600 text-white rounded-lg shadow-md hover:bg-blue-700 transition duration-300"
                >
                    <Download size={18} />
                    Download CV
                </a>
